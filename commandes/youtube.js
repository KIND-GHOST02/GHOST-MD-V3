...
_*GHOST-MD VIDEO DOWNLOADING......*_\n\n`
      };
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*GHOST-MD*", gifPlayback: false }, { quoted: ms });
      });
